...
import 'package:smartFin/features/categories/data/repository/category_repositoy.dart';
...
class CategoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<CategorySectionEntity> categories = CategoryRepository.sections;
    return Scaffold(
        appBar: MyAppBar(
